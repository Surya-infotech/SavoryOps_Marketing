...
import { MdFastfood, MdArrowForward } from 'react-icons/md';

export default function UserApp() {
  const demoLink = import.meta.env.VITE_USER_APP_DEMO || '#';
    ...
    <div className="bg-[#f8f9fa] min-h-screen pt-24 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-[3rem] p-10 md:p-16 shadow-soft border border-slate-200 text-center max-w-4xl mx-auto animate-slide-up">
           ...
           <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">User Ordering App</h1>
           <p className="text-lg text-slate-500 mb-10 leading-relaxed font-medium">
             A premium mobile app experience for customers. Give diners the power to order food, book tables, use QR menus, and track deliveries right from their phones.
           </p>
